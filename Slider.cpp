...
Slider::Slider(Vector2f bodySize, Vector2f sliderSize, Vector2f position, float min, float max, string text, Font &font)
{
	...
	m_body.setFillColor(Color::Yellow) ; m_body.setOutlineColor(Color::Black) ; m_body.setOutlineThickness(3) ;
	m_slider.setFillColor(Color::White) ;  m_slider.setOutlineColor(Color::Black) ; m_slider.setOutlineThickness(3) ; 
	...
	ostringstream oss ; oss<<getSliderValue() ;
